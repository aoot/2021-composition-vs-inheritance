'''
Very advanced employee management system (with inheritance).
'''
...
class HourlyEmployee(Employee):
    '''Emploeye that's paid based on number of worked hours.'''
...
class SalariedEmployee(Employee):
    '''Employee that's paid baed on a fixed monthly salary.'''
...
@dataclass
class FreelanceWithCommission(Freelancer):
